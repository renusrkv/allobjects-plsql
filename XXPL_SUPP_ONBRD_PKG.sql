CREATE OR REPLACE PACKAGE BODY APPS.XXPL_SUPP_ONBRD_PKG
IS
    ...
    BEGIN
        ...
        BEGIN
            SELECT NVL ((SELECT ENTITY_NAME
                           FROM XXPL.XXPL_SUPP_DATA_MANAGEMENT
              ...
              FROM APPS.XXPL_SUPP_ONBOARD_REQUEST      REQ,
                   APPS.XXPL_PROSPECTIVE_SUPPLIER_REG  PREG
        ...
        BEGIN
            SELECT 1
              INTO l_CHECK
              FROM lfnd_lookups
             WHERE     LOOKUP_TYPE = 'XXPL_SUPP_ONBRD_DISPLAY_COND'
                   AND KEY1 = 'Alternate'
    ...
    BEGIN
        BEGIN
            SELECT COUNT (1)
              INTO L_COUNT
              FROM XXPL.XXPL_PROSPECTIVE_SUPPLIER_REG
             WHERE REGI_REQUEST_NUMBER = p_req_num;
        EXCEPTION
            WHEN OTHERS
            THEN
    ...
    BEGIN
        BEGIN
            SELECT COUNT (1)
              INTO L_COUNT
              FROM XXPL.XXPL_PROS_SUPP_REG_ADD_INFO
             WHERE REGI_REQUEST_NUMBER = p_req_num;
        EXCEPTION
            WHEN OTHERS
            THEN
    ...
    BEGIN
        ...
        BEGIN
            SELECT KEY2,
             ...
             WHERE     1 = 1
                   AND lkup.LOOKUP_TYPE = 'XXPL_SUPP_ONBRD_BANK_FIELDS'
        ...
        BEGIN
            SELECT NVL (
                       (SELECT KEY4
                          FROM lfnd_lookups
                         WHERE     1 = 1
                               AND LOOKUP_TYPE = 'XXPL_SUPP_ONBRD_ENTITIES'
                               AND KEY5 = 'Yes'
                               AND KEY1 = l_segment1
                               AND ROWNUM = 1),
                       (SELECT KEY4
    ...
    BEGIN
        BEGIN
            SELECT COUNT (1)
              INTO L_ROWCOUNT
              FROM XXPL_SUPP_DATA_MANAGEMENT
        ...
        WRITE_CUST_LOG (
            ...
            'CREATE_DATA_MANAGEMENT',
               'Enter into the CREATE_DATA_MANAGEMENT XXPLc and L_ROWCOUNT is '
            || L_ROWCOUNT);

        IF L_ROWCOUNT = 0
        THEN
            BEGIN
                INSERT INTO XXPL.XXPL_SUPP_DATA_MANAGEMENT (
                                REGI_REQUEST_NUMBER,
                                COMPANY_NAME,
                                CREATED_BY,
                                CREATION_DATE,
                    ...
                    SELECT TO_NUMBER (TRIM (p_req_num)),
					    ...
					    -- NVL (INFO.BANK_CODE, JP_BANK_CODE)   Commeted the XXPLc for Bank Code not appearing in the Notification 17-Jan-19
						   NVL (NVL (INFO.BANK_CODE, JP_BANK_CODE),TW_BANK_CODE)   --Added the XXPLc for showing Bank Code information into the Notification 17-Jan-19
                               BANK_CODE,
                           (CASE
                           ...
                           NULL, --  XXPLSuppDataManagement.SUPPLIER_BANK_NAME,
                           NULL, -- XXPLSuppDataManagement.SUPPLIER_BANK_COUNTRY,
                           NULL,        -- XXPLSuppDataManagement.BANK_NUMBER,
                           NULL,        -- XXPLSuppDataManagement.BRANCH_NAME,
                           NULL,      -- XXPLSuppDataManagement.BRANCH_NUMBER,
                           NULL,                -- XXPLSuppDataManagement.BIC,
                           NULL,        -- XXPLSuppDataManagement.BRANCH_TYPE,
                           (CASE
                           ...
                           (SELECT lkp2.KEY5
                             ...
                             WHERE     1 = 1
                                   AND lkp1.LOOKUP_TYPE =
                                       'XXPL_SUPP_ONBRD_ENTITIES'
                                   AND lkp2.LOOKUP_TYPE =
                                       'XXPL_SUPP_ONBRD_OU_INFO'
                           ...
                           NVL (CH_BRANCH_NAME, TW_BRANCH_NAME)
                               BANK_BRANCH_NAME
                      FROM XXPL.XXPL_PROSPECTIVE_SUPPLIER_REG  reg,
                           XXPL.XXPL_PROS_SUPP_REG_ADD_INFO    info,
                           XXPL.XXPL_SUPP_ONBOARD_REQUEST      onb
                     WHERE     1 = 1
            ...
            /*                        AND NOT EXISTS
                                           (SELECT 1
                                              FROM XXPL.XXPL_SUPP_DATA_MANAGEMENT SDM1
        ...
        THEN
            ...
            UPDATE XXPL_SUPP_DATA_MANAGEMENT
    ...
    AS
        ...
        vRoleCount                       NUMBER;
        l_transaction_type               VARCHAR2 (30) := 'XXPL_SUPP_ONBRD_REG';
        ...
        l_callingProgram                 VARCHAR2 (150)
                                             := 'XXPLSupplieronBoardingApproval';
    ...
    BEGIN
        UPDATE XXPL.XXPL_SUPP_ONBOARD_REQUEST req
        ...
        UPDATE XXPL_PROS_SUPP_REG_ADD_INFO
           SET SUBMITTED = NULL
        ...
        UPDATE XXPL.XXPL_PROSPECTIVE_SUPPLIER_REG
           SET SUBMITTED = NULL
         WHERE ITEM_TYPE = itemtype AND ITEM_KEY = itemkey;
        ...
        BEGIN
            SELECT ENTITY_NAME_SUPP_REGI_IN,
              ...
              INTO l_ENTITY_NAME_SUPP_REGI_IN,
                   l_REQUESTOR_NAME,
                   l_EMAIL_ADDRESS1
              FROM XXPL_SUPP_ONBOARD_REQUEST req
             WHERE req.REGI_REQUEST_NUMBER =
                   (SELECT REGI_REQUEST_NUMBER
                      FROM XXPL.XXPL_PROSPECTIVE_SUPPLIER_REG
                     WHERE ITEM_TYPE = itemtype AND ITEM_KEY = itemkey);
        ...
        WRITE_CUST_LOG (
            itemkey,
            'XXPL_SUPP_ONBRD_PKG.REJECT_ATT_VALUES',
               l_Responder
            || '  $  '
            || l_Responder_Name
            || '  $  '
        ...
        l_transaction_type := 'XXPL_PROS_SUPP_REG';
        ...
        BEGIN
            SELECT CASE
                       ...
                       THEN
                           'XXPL_PROS_SUPP_REG_ROLE_' || itemkey
                       ELSE
                              'XXPL_PROS_SUPP_REG_ROLE_'
                           || itemkey
                           || '_'
                           || l_approver_count
                   END
        ...
        BEGIN
            l_dm_role_name := 'XXPL_DATA_MANAGEMENT_TEAM_' || itemkey;
                                         ...
                                         WHERE     LOOKUP_TYPE =
                                               ...
                                               AND KEY4 =
                                                   (SELECT NVL (
                                                               ...
                                                               REQ.ENTITY_NAME_SUPP_REGI_IN)
                                                      FROM APPS.XXPL_SUPP_ONBOARD_REQUEST
                                                           REQ,
                                                           APPS.XXPL_PROSPECTIVE_SUPPLIER_REG
                                                           PREG
                                                     WHERE     REQ.REGI_REQUEST_NUMBER =
    ...
    AS
        ...
        vProcess      VARCHAR2 (50) := 'XXPL_DISQUALIFY_SUPPLIER';
        vForm         VARCHAR2 (50);
    ...
    BEGIN
        ...
        UPDATE XXPL.XXPL_SUPP_DATA_MANAGEMENT
    ...
    AS
        PRAGMA AUTONOMOUS_TRANSACTION;
        vItemType         VARCHAR2 (30) := 'LSUONBDR';
        vProcess          VARCHAR2 (50) := 'XXPL_NOTIFY_SUPPLIER';
        vForm             VARCHAR2 (50);
        vsqlerrm          VARCHAR2 (110);
        vDocumment        CLOB;
        vPrimaryKey       NUMBER;
    ...
    BEGIN
        BEGIN
            WRITE_CUST_LOG (itemkey,
                            'XXPL_SUPP_ONBRD_PKG.Data_Man_Notify_Supplier',
                            'Entered into Data_Man_Notify_Supplier XXPLc');
            ...
            SELECT SUPPLIER_NAME, REQUESTOR_NAME, CONTACT_PERSON_MAIL_ID
              ...
              FROM XXPL_SUPP_ONBOARD_REQUEST
            ...
            UPDATE XXPL_PROSPECTIVE_SUPPLIER_REG
               SET SUBMITTED = NULL
             WHERE REGI_REQUEST_NUMBER = vRequestNumber;
            ...
            UPDATE XXPL.XXPL_SUPP_ONBOARD_REQUEST
            ...
            vSuppProsRequestPage :=
                FND_RUN_FUNCTION.get_run_function_url (
                    p_function_id =>
                        fnd_function.get_function_id ('XXPL_SUPP_ONBRD_PROS'),
                    p_resp_appl_id =>
                        NULL,
                    p_resp_id =>
                        NULL,
            ...
            wf_engine.setitemattrtext (
                itemtype   => itemtype,
                itemkey    => itemkey,
                aname      => 'XXPL_SUPP_ONBDR_PROS_PAGE',
            ...
            EXCEPTION
                ...
                THEN
                    WRITE_CUST_LOG (
                        itemkey,
                        'XXPL_SUPP_ONBRD_PKG.start_Notify_wf',
    ...
    BEGIN
        BEGIN
            ...
            UPDATE XXPL_SUPP_ONBOARD_REQUEST
...
We regret to inform you that your company was not approved as a XXPLtech supplier per comment below.

Comment:  '
                || vNoteToSupplier
                || '

If you have questions or concerns, please contact:  Global_Procurement_Team@XXPLtech.com
...
Global Procurement Department';
            ...
            wf_engine.setitemattrtext (
                itemtype   => itemtype,
                itemkey    => itemkey,
                aname      => 'XXPL_SOB_DISQUALIFY_NOTE',
        ...
        EXCEPTION
            ...
            THEN
                WRITE_CUST_LOG (
                    itemkey,
                    'XXPL_SUPP_ONBRD_PKG.Data_Man_Disqualify_Supplier',
                       'vSupplierName,vRequestorName,vSupplierMailId  --> '
                    || SQLERRM);
                resultout := 'COMPLETE:' || 'N';
        END;
    ...
    BEGIN
        ...
        BEGIN
            SELECT DISTINCT lkp1.KEY4
             ...
             WHERE     lkp1.LOOKUP_TYPE = 'XXPL_SUPP_ONBRD_TEAM_MEMBERS'
        ...
        BEGIN
            SELECT ITEM_TYPE, ITEM_KEY
              ...
              FROM XXPL_PROSPECTIVE_SUPPLIER_REG
    ...
    --------------------------------------------------------Work flow XXPLcs Started ------------------------------------------

    PROCEDURE START_WF (pItemKey VARCHAR2)
    IS
        PRAGMA AUTONOMOUS_TRANSACTION;
        vItemType            VARCHAR2 (30) := 'LSUONBDR';
        vProcess             VARCHAR2 (50) := 'XXPL_SUPP_ONBDR_APP_PROCESS';
        vForm                VARCHAR2 (50);
        vsqlerrm             VARCHAR2 (110);
        vDocumment           CLOB;
        vPrimaryKey          NUMBER;
    ...
    BEGIN
        ...
        BEGIN
            ...
            Wf_Engine.setitemattrdocument (
                ...
                pItemKey,
                'EXCEL_ATTACHEMENT',
                   'FND:entity=XXPL_SUPPONBORD&pk1name=XXPL_SUPPONBORD&pk1value='
                || vPrimaryKey);
        EXCEPTION
            WHEN OTHERS
            THEN
                WRITE_CUST_LOG (
                    pItemKey,
                    'XXPL_SUPP_ONBRD_PKG.DERIVE_APPROVERS',
    ...
    BEGIN
        ...
        BEGIN
            SELECT REGI_REQUEST_NUMBER, REQUESTOR_NAME
              ...
              FROM XXPL.XXPL_SUPP_ONBOARD_REQUEST
        ...
        l_AdHocRoleName := 'XXPL_SUPP_ONBDR_REG_ROLE_' || itemkey;
    ...
    EXCEPTION
        ...
        THEN
            ...
            WF_CORE.Context (
                ...
                itemkey,
                TO_CHAR (actid),
                   'Error in XXPL_SUPP_ONBRD_PKG.DERIVE_APPROVERS -->'
                || SQLERRM);
    ...
    BEGIN
        ...
        BEGIN
            ...
            wf_engine.setitemattrtext (
                itemtype   => itemtype,
                itemkey    => itemkey,
                aname      => 'XXPL_SUPP_ONBDR_SEARCH_PAGE',
            ...
            wf_engine.setitemattrtext (
                itemtype   => itemtype,
                itemkey    => itemkey,
                aname      => 'XXPL_SUPP_ONBDR_REGI_PAGE',
        ...
        EXCEPTION
            ...
            THEN
                WRITE_CUST_LOG (
                    itemkey,
                    'XXPL_SUPP_ONBRD_PKG.POPULATE_WF_ATTR',
                       'vSupplierName,vRequestorName,vSupplierMailId  --> '
                    || SQLERRM);
        END;
            ...
            THEN
                BEGIN
                    SELECT USER_NAME
                      ...
                      FROM WF_USER_ROLES
                     WHERE     role_name =
                               'XXPL_SUPP_ONBDR_REG_ROLE_' || itemkey
                           AND ROWNUM = 1;
    ...
    BEGIN
        ...
        EXCEPTION
            ...
            THEN
                WRITE_CUST_LOG (itemkey,
                                'XXPL_SUPP_ONBRD_PKG.Approve_notification',
    ...
    BEGIN
        SELECT COUNT (1)
          INTO vSupplierExist
          FROM XXPL_SUPP_ONBOARD_REQUEST req, LFND_LOOKUPS lkup
         WHERE     1 = 1
               AND req.SUPPLIER_TYPE = lkup.KEY3
               AND lkup.LOOKUP_TYPE = 'XXPL_SUPP_ONBRD_FRM_VALUES'
    ...
    EXCEPTION
        ...
        THEN
            resultout := 'COMPLETE:' || 'N';
            WRITE_CUST_LOG (itemkey,
                            'XXPL_SUPP_ONBRD_PKG.VENDOR_TYPE',
                            'outter most exception  --> ' || SQLERRM);
    END NOTIFY_VENDOR;
    ...
    EXCEPTION
        ...
        THEN
            WRITE_CUST_LOG (itemkey,
                            'XXPL_SUPP_ONBRD_PKG.Reject_notification',
                            'Outter Most exception  --> ' || SQLERRM);
    ...
    IS
        PRAGMA AUTONOMOUS_TRANSACTION;
        vItemType            VARCHAR2 (30) := 'LSUONBDR';
        vProcess             VARCHAR2 (50) := 'XXPL_PROS_SUPPLIER_REGI_REQST';
        vForm                VARCHAR2 (50);
        vsqlerrm             VARCHAR2 (110);
        vDocumment           CLOB;
        vPrimaryKey          NUMBER;
    ...
    BEGIN
        ...
        BEGIN
            ...
            Wf_Engine.setitemattrdocument (
                ...
                pItemKey,
                'EXCEL_ATTACHEMENT',
                   'FND:entity=XXPL_PROSUPREG&pk1name=XXPL_PROSUPREG&pk1value='
                || vPrimaryKey);
        EXCEPTION
            WHEN OTHERS
            THEN
    ...
    AS
        l_request_number                 NUMBER;
        l_transaction_type               VARCHAR2 (30) := 'XXPL_PROS_SUPP_REG';
        l_application_Id                 NUMBER := 60007;
        l_approver_id                    NUMBER (15) := NULL;
        l_approver_name                  VARCHAR2 (150);
        l_approver_name_display          VARCHAR2 (150);
    ...
    BEGIN
        ...
        EXCEPTION
            ...
            THEN
                WRITE_CUST_LOG (
                    itemkey,
                    'XXPL_SUPP_ONBRD_PKG.DERIVE_APPROVERS1',
                    'REGI_REQUEST_NUMBER derivation issue -->' || SQLERRM);
        END;
        ...
        EXCEPTION
            ...
            THEN
                WRITE_CUST_LOG (
                    itemkey,
                    'XXPL_SUPP_ONBRD_PKG.DERIVE_APPROVERS1',
                    ' XXPL_SUPP_DATA_MANAGEMENT update issue -->' || SQLERRM);
        END;
        ...
        THEN
            ...
            l_role_name := 'XXPL_PROS_SUPP_REG_ROLE_' || itemkey;
    ...
    BEGIN
        ...
        BEGIN
            ...
            wf_engine.setitemattrtext (
                itemtype   => itemtype,
                itemkey    => itemkey,
                aname      => 'XXPL_SUPP_DATA_MANAG_PAGE',
...
Dear Supplier,
         ...
         On behalf of XXPLtech we would like to inform you that your information has been reviewed and approved. We welcome you as a new XXPLtech supplier!
We would like to remind you that a contract and a Purchase Order must be in place before any work is started.
Please engage with your XXPLtech contact to confirm all steps are completed and to ask any questions regarding the process.

Sincerely,
XXPLtech Global Procurement
Global_Procurement_Team@XXPLtech.com';
        ...
        EXCEPTION
            ...
            THEN
                WRITE_CUST_LOG (
                    itemkey,
                    'XXPL_SUPP_ONBRD_PKG.POPULATE_WF_ATTR1',
                       'vSupplierName,vRequestorName,vSupplierMailId  --> '
                    || SQLERRM);
        END;
    ...
    BEGIN
        BEGIN
            ...
            WRITE_CUST_LOG (
                itemkey,
                'XXPL_SUPP_ONBRD_PKG.APPROVE_NOTIFICATION1',
                   l_Responder
                || '  $  '
                || l_Responder_Name
                || '  $  '
    ...
    BEGIN
        ...
        WRITE_CUST_LOG (itemkey,
                        'XXPL_SUPP_ONBRD_PKG.Notify_Vendor1',
    ...
    BEGIN
        ...
        THEN
            ...
            SELECT ll.KEY2
              INTO l_region
              FROM lfnd_lookups ll, XXPL_SUPP_DATA_MANAGEMENT Data
             WHERE     ll.LOOKUP_TYPE = 'XXPL_SUPP_ONBRD_ENTITIES'
        ...
        THEN
            BEGIN
                l_ocrm_role_name :=
                    'XXPL_OCRM_TEAM_' || l_region || '_' || itemkey;

                WRITE_CUST_LOG (
                    itemkey,
                    'XXPL_SUPP_ONBRD_PKG.CREATE_SUPPLIER',
                ...
                FOR DM_USER
                    IN (SELECT KEY3, KEY2
                          FROM lfnd_lookups
                         WHERE     LOOKUP_TYPE =
                                   'XXPL_SUPP_ONBRD_OCRM_EMAIL_ADD'
                               AND KEY1 = l_region)
                LOOP
...
--                              FROM XXPL_PROSPECTIVE_SUPPLIER_REG pros
...
--                             WHERE pros.REGI_REQUEST_NUMBER = P_REG_REQ_NUM)
    ...
    BEGIN
        BEGIN
            SELECT XXPL.XXPL_SUP_ONBDR_CUST_LOG_S.NEXTVAL
              INTO L_SEQ_ID
              FROM DUAL;
        EXCEPTION
            WHEN OTHERS
        ...
        BEGIN
            ...
            INSERT INTO XXPL.XXPL_SUP_ONBDR_CUST_LOG (RECORD_ID,
                                                      LOG_TYPE,
                                                      SEQ,
                                                      LOG_TEXT,
                                                      USER_ID,
    ...
    BEGIN
        ...
        THEN
            BEGIN
                SELECT 'Y'
                  INTO vValidUser
                  FROM XXPL.XXPL_SUPP_ONBOARD_REQUEST  OBDR,
